...
namespace Elagy.DAL.Migrations
{
    ...
    [Migration("20250711134056_CarRentalAppoinmentDataTimeChangedTobeDateOnly")]
    partial class CarRentalAppoinmentDataTimeChangedTobeDateOnly
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elagy.Core.Entities.HotelAssetImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elagy.Core.Entities.CarRentalAppointment", b =>
                {
                    b.HasOne("Elagy.Core.Entities.CarSchedule", "CarSchedule")
                        .WithMany()
                        .HasForeignKey("CarScheduleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("CarSchedule");
                });
            ...
            modelBuilder.Entity("Elagy.Core.Entities.HospitalAsset", b =>
                {
                    b.Navigation("HospitalAssetImages");
