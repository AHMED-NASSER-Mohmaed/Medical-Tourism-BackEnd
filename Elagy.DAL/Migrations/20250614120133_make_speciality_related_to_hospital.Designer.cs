...
namespace Elagy.DAL.Migrations
{
    ...
    [Migration("20250614120133_make_speciality_related_to_hospital")]
    partial class make_speciality_related_to_hospital
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Elagy.Core.Entities.Doctor", b =>
                {
                    ...
                    b.HasOne("Elagy.Core.Entities.Specialty", null)
                        .WithMany("Doctors")
                        .HasForeignKey("SpecialtyId");
